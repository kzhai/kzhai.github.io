...
\begin{itemize}
\item Lead the large scale infrastructure migration for Copilot response quality evaluation to LangChain and Azure Databricks.
\item Lead the automatic prompt optimization and hill-climbing framework with GEPA algorithm for production Copilot, significantly speed up the prompt engineering process from 2 weeks to $<$2 days with performance guarantee.
\end{itemize}
