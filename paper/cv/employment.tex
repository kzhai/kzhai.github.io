...
\begin{itemize}
\item Founding member of Apple's responsible AI team.
\item Infrastructure architect for the team on automatic red-teaming data synthesization, on-device inference/simulation, auto grading and metric reporting platform. The designed system has shown to be highly extensible, customizable, and scalable, which powers all the safety evaluations.
\item Tech lead for red teaming efforts for Apple Intelligence features, including web QA, text summarization, text composition and text assistants.
\item Tech lead for safety benchmark evaluation on Apple Intelligence models, including harmfulness, responsiveness, biases and fairness.
