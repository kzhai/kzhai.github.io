...
{\bf Principle Research Scientist, Member of Technical Staff} \hfill Microsoft AI, Mountain View, CA, Nov 2025 - Present
\begin{itemize}
\item Lead the large scale infrastructure migration for Copilot response quality evaluation to Azure Databricks.
\item Lead the automatic production prompt optimization and hill-climbing framework with GEPA algorithm for Copilot, significantly speed up the prompt engineering process from 2 weeks to <2 days with performance guarantee.
\end{itemize}
