  ...
  \item Maintaining end-to-end data processing, model training and adaptation evaluation pipeline.
  \item Language model training and adaptation support for Microsoft Teams project (a prototype of the product was demo'ed at Microsoft Build conference 2018).
  \end{itemize}
